...
public class AlignToTag extends Command{
    ...
    public AlignToTag(RobotBase<SwerveDrivetrain> base, String camera, ReefScoringPos pose){
        this(base, camera, pose.getSide());
    }

    public AlignToTag(RobotBase<SwerveDrivetrain> base, String camera, ReefPole pole){
        this(base, camera, pole.getApriltagId());
    }
    ...
    public AlignToTag(RobotSpeeds speeds, LimeLight camera, long... idFilter){
        ...
        this.pose = new FilteredPose(() -> camera.getPoseEstimate(PoseEstimateType.BOT_POSE_TARGET_SPACE).getPose())
                    .addMedianFilter(25);
