...
public class ReefScoringPos {
    ...
    private final ReefPole side;
     ...
     public enum ReefPole {
        ...
        //LEFT
        A(18, 7, new Pose2d(11.757,4.200, Rotation2d.fromDegrees(0)), new Pose2d(3.241, 4.200,  Rotation2d.fromDegrees(180)), Autos.PATHS.SIDEA,0.0, new Pose2d(-0.4568, 0.128,new Rotation2d())),
        //RIGHT
        B(18, 7, new Pose2d(11.776,3.880, Rotation2d.fromDegrees(180)), new Pose2d(3.211,3.880, Rotation2d.fromDegrees(180)), Autos.PATHS.SIDEA,0.0, new Pose2d(-0.437, -0.173,new Rotation2d())),

        C(17, 8, new Pose2d(12.275,3.033,  Rotation2d.fromDegrees(-120)), new Pose2d(3.699,3.033, Rotation2d.fromDegrees(-120)), Autos.PATHS.SIDEC,0.0, new Pose2d(-0.378, -0.332,new Rotation2d())),
        D(17, 8, new Pose2d(12.574,2.863,  Rotation2d.fromDegrees(-120)), new Pose2d(3.969,2.863, Rotation2d.fromDegrees(-120)), Autos.PATHS.SIDEC,0.0, new Pose2d(-0.07, -0.47,new Rotation2d())),

        E(22, 9, new Pose2d(13.561,2.863,  Rotation2d.fromDegrees(-60)), new Pose2d(4.956,2.853,  Rotation2d.fromDegrees(-60)), Autos.PATHS.SIDEE,0.0, new Pose2d(0.1768, -0.423,new Rotation2d())),
        F(22, 9, new Pose2d(13.861,2.993,  Rotation2d.fromDegrees(-60)), new Pose2d(5.245,2.993,  Rotation2d.fromDegrees(-60)), Autos.PATHS.SIDEE,0.0, new Pose2d(0.39, -0.296,new Rotation2d())),

        //0.453, -0.05
        G(21, 10, new Pose2d(14.369,3.860, Rotation2d.fromDegrees(0)), new Pose2d(5.754,3.860, Rotation2d.fromDegrees(0)), Autos.PATHS.SIDEG,0.0, new Pose2d(0.3967, -0.252,new Rotation2d())),
        H(21, 10, new Pose2d(14.359,4.200, Rotation2d.fromDegrees(0)), new Pose2d(5.754,4.200, Rotation2d.fromDegrees(0)), Autos.PATHS.SIDEG,0.0, new Pose2d(0.485, 0.1722,new Rotation2d())),

        //0.37, 0.34,
        //0.12, 0.47
        I(20, 11, new Pose2d(13.880,5.007, Rotation2d.fromDegrees(60)), new Pose2d(5.285,5.007,  Rotation2d.fromDegrees(60)), Autos.PATHS.SIDEI,0.0, new Pose2d(0.388, 0.337,new Rotation2d())),
        J(20, 11, new Pose2d(13.561,5.207, Rotation2d.fromDegrees(60)), new Pose2d(4.986,5.207,  Rotation2d.fromDegrees(60)), Autos.PATHS.SIDEI,0.0, new Pose2d(0.0664, 0.481,new Rotation2d())),
        //new Pose2d(Units.inchesToMeters(24), Units.inchesToMeters(-7.8),new Rotation2d())
        //-0.1, 0.48
        K(19, 6, new Pose2d(12.594,5.187, Rotation2d.fromDegrees(120)), new Pose2d(3.989,5.187, Rotation2d.fromDegrees(120)), Autos.PATHS.SIDEK,0.0, new Pose2d(-0.107, 0.488,new Rotation2d())),
        L(19, 6, new Pose2d(12.325,5.027, Rotation2d.fromDegrees(120)), new Pose2d(3.719,5.027, Rotation2d.fromDegrees(120)), Autos.PATHS.SIDEK,0.0, new Pose2d(-0.390, 0.27,new Rotation2d()));
